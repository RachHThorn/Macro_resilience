# R Thornley (modified from Rob Salguero Gomez script 'COMPADRE demographics' 2017)
# 19/11/2024
# Calculate demographic metrics for the overlapping species of DRAGNet and COMPADRE

library(tidyverse) # select has conflict with MASS package
library(popbio)   #This packages includes some basic matrix analyses
library(popdemo)  #This package includes some advanced transient measures
library(Rage) # life history metrics from MPMs
library(Rcompadre) # interacts with compadre and compadre data-bases
...
# save some vars for the function below

# save length of data object
...
# write_csv(output, "results/March_2025/meta_data_compadre.csv")
